...
-- Started on 2022-05-19 21:22:03 UTC
...
CREATE TABLE public.company (
    ...
    f_alta date,
    c_usuario_alta character varying(50),
    f_actualizac date,
    c_usuario_act character varying(50)
);
...
-- Name: pistas; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.pistas OWNER TO postgres;

--
-- TOC entry 220 (class 1259 OID 16801)
-- Name: pistas_id_pista_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.pistas_id_pista_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.pistas_id_pista_seq OWNER TO postgres;

--
-- TOC entry 3365 (class 0 OID 0)
-- Dependencies: 220
-- Name: pistas_id_pista_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.pistas_id_pista_seq OWNED BY public.pistas.id_pista;


--
-- TOC entry 219 (class 1259 OID 16795)
-- Name: sec_id_company; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.sec_id_company
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.sec_id_company OWNER TO postgres;
...
--
-- TOC entry 3193 (class 2604 OID 16792)
...
-- Name: pistas id_pista; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pistas ALTER COLUMN id_pista SET DEFAULT nextval('public.pistas_id_pista_seq'::regclass);


--
-- TOC entry 3349 (class 0 OID 16755)
-- Dependencies: 213
...
--
-- TOC entry 3350 (class 0 OID 16760)
-- Dependencies: 214
...
--
-- TOC entry 3354 (class 0 OID 16789)
-- Dependencies: 218
-- Data for Name: company; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.company (id_company, nombre, f_alta, c_usuario_alta, f_actualizac, c_usuario_act) FROM stdin;
1	Universal Music Group	2022-05-19	postgres	2022-05-19	postgres
2	Sony Music Entertainment	2022-05-19	postgres	2022-05-19	postgres
3	Warner Music Group	2022-05-19	postgres	2022-05-19	postgres
4	YG Entertainment	2022-05-19	postgres	2022-05-19	postgres
5	SM Entretainment	2022-05-19	postgres	2022-05-19	postgres
6	JYP Entertainment	2022-05-19	postgres	2022-05-19	postgres
7	Sony Music Entertainment US Latin LLC	2022-05-19	postgres	2022-05-19	postgres
8	PolyGram	2022-05-19	postgres	2022-05-19	postgres
9	DEL Records	2022-05-19	postgres	2022-05-19	postgres
10	Epic Records	2022-05-19	postgres	2022-05-19	postgres
\.


--
-- TOC entry 3351 (class 0 OID 16765)
-- Dependencies: 215
...
--
-- TOC entry 3357 (class 0 OID 16802)
-- Dependencies: 221
-- Data for Name: pistas; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.pistas (id_pista, id_album, nombre, "número", duracion_seg, f_alta, c_usuario_alta, f_actualizac, c_usuario_act) FROM stdin;
1	1WFozsJ1CQfkuGcd9GjYTX	Young Blood	1	211	2022-05-19	postgres	2022-05-19	postgres
2	1WFozsJ1CQfkuGcd9GjYTX	Rough an Ready	2	172	2022-05-19	postgres	2022-05-19	postgres
3	1WFozsJ1CQfkuGcd9GjYTX	Bloody Luxury	3	203	2022-05-19	postgres	2022-05-19	postgres
4	1WFozsJ1CQfkuGcd9GjYTX	Victim of Love	4	213	2022-05-19	postgres	2022-05-19	postgres
5	1WFozsJ1CQfkuGcd9GjYTX	Crying in the Rain	5	361	2022-05-19	postgres	2022-05-19	postgres
6	400D8LXbvMuOzi4lVv89FM	When We Were Us	1	214	2022-05-19	postgres	2022-05-19	postgres
7	400D8LXbvMuOzi4lVv89FM	Walls	2	217	2022-05-19	postgres	2022-05-19	postgres
8	400D8LXbvMuOzi4lVv89FM	This House Is Not For Sale	3	216	2022-05-19	postgres	2022-05-19	postgres
9	400D8LXbvMuOzi4lVv89FM	Living With The Ghost	4	284	2022-05-19	postgres	2022-05-19	postgres
10	400D8LXbvMuOzi4lVv89FM	Knockout	5	209	2022-05-19	postgres	2022-05-19	postgres
\.


--
-- TOC entry 3352 (class 0 OID 16768)
-- Dependencies: 216
...
45	carlos	x	youtube	algo@algo.COM	32112	HTTP://WWW.algo.COM	10	2022-05-19	postgres	2022-05-19	postgres
\.
...
SELECT pg_catalog.setval('public.company_id_company_seq', 10, true);


--
-- TOC entry 3367 (class 0 OID 0)
-- Dependencies: 220
-- Name: pistas_id_pista_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.pistas_id_pista_seq', 10, true);


--
-- TOC entry 3368 (class 0 OID 0)
-- Dependencies: 219
-- Name: sec_id_company; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.sec_id_company', 1, false);


--
-- TOC entry 3196 (class 2606 OID 16774)
...
--
-- TOC entry 3198 (class 2606 OID 16776)
...
--
-- TOC entry 3206 (class 2606 OID 16809)
-- Name: pistas pistas_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pistas
    ADD CONSTRAINT pistas_pkey PRIMARY KEY (id_pista);
...
--
-- TOC entry 3207 (class 2606 OID 16781)
...
--
-- TOC entry 3209 (class 2606 OID 16810)
-- Name: pistas pistas_id_album_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pistas
    ADD CONSTRAINT pistas_id_album_fkey FOREIGN KEY (id_album) REFERENCES public.albums(id_album);


--
-- TOC entry 3208 (class 2606 OID 16796)
-- Name: usuarios usuarios_id_company_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.usuarios
    ADD CONSTRAINT usuarios_id_company_fkey FOREIGN KEY (id_company) REFERENCES public.company(id_company);


-- Completed on 2022-05-19 21:22:03 UTC
